...
export default function Work() {
  ...
  return work.length ? <WorkContent work={work} /> : null;
}

function WorkContent({ work }) {
  const [headRef, headSeen] = useReveal();
  const { ref: stripRef } = useDragScroll();
      ...
      <div className="mm-shell">
        <div ref={headRef} className={revealClass(headSeen, "mm-work__head")}>
          ...
          <div className="mm-work__intro">
            <p className="mm-lede">
              A few recent blooms — rebrands, campaigns and content engines that
              moved real numbers for real businesses.
            </p>
